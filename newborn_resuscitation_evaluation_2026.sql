...
-- Form pick: old 18-item /18 when date_submitted < 2026-04-01 AND any classic
--   18-item integer IS NOT NULL; otherwise new-form /46.5.
--   Pre-cutoff new-form-only rows (empty old ints) correctly use /46.5.
-- Old-form integers are COALESCE to 0 so sparse nulls cannot NULL the average_score.
