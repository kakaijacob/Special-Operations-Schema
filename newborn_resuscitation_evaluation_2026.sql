...
-- Form cutoff: old 18-item formula when date_submitted < 2026-04-01 AND no new-form
--   item is TRUE (documentation_nnr / q1a_gestational_age / shout_help_nnr). Otherwise /46.5.
--   (false ≠ absent: do not use IS NULL for form detect — that zeroed Cohort 1 scores.)
