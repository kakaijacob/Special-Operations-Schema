with db_mentees as (
    ...
    where lowerUTF8(program) in ('newborn curriculum', 'both')
...
fact_mentees as (
    ...
    from (
        select
            ...
            facility,
            facility_code
        from {{ ref('stg_mentors__newborn_curriculum_tracking') }}
        ...
        select
            ...
            facility,
            facility_code
        from {{ ref('stg_mentors__newborn_resuscitation_assessments') }}
    )
